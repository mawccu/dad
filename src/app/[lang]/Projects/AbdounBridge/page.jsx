...
export default function AbdounBridge() {
  ...
  return (
    ...
    operations. */}
        ...
        <p className={`font-400 leading-relaxed text-gray-500 ${lang === 'ar' ? 'text-xl' : 'text-lg'}`} dangerouslySetInnerHTML={{ __html: t('projects.wadiAbdoun.section2_body') }} />
    ...
    operations. */}
        ...
        <p className={`font-400 leading-relaxed text-gray-500 ${lang === 'ar' ? 'text-xl' : 'text-lg'}`} dangerouslySetInnerHTML={{ __html: t('projects.wadiAbdoun.section3_body') }} />
      </section>
