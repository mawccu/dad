                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center px-8 transform transition-transform duration-300 group-hover:translate-y-[-10px]">
                        ...
                        <div className="space-y-6">
                            {[
                                { title: t('services.surface_finishing_page.panel2_items.0.title'), desc: t('services.surface_finishing_page.panel2_items.0.desc') },
                                { title: t('services.surface_finishing_page.panel2_items.1.title'), desc: t('services.surface_finishing_page.panel2_items.1.desc') },
                                { title: t('services.surface_finishing_page.panel2_items.2.title'), desc: t('services.surface_finishing_page.panel2_items.2.desc') },
                                { title: t('services.surface_finishing_page.panel2_items.3.title'), desc: t('services.surface_finishing_page.panel2_items.3.desc') },
                            ].map((item, index) => (
                                <div 
                                    key={item.title}
                                ...
                                >
                                    <h4 className={`${lang === 'ar' ? 'text-3xl' : 'text-2xl'} font-medium text-gray-800 mb-2 group-hover:text-gray-900 transition-colors duration-300`}>
                                        {item.title}
                                    </h4>
                                    <p className={`${lang === 'ar' ? 'text-2xl' : 'text-xl'} font-light text-gray-700 opacity-80 group-hover:opacity-100 transition-all duration-300`}>
                                        {item.desc}
                                    </p>
                                </div>
                            ))}
  ...
  <div className="flex gap-6 mb-16 px-12">
    ...
    >
      ...
      <div className="absolute inset-0 flex p-4 items-center justify-between flex-col text-white">
        <p className={`${lang === 'ar' ? 'text-3xl' : 'text-2xl'} font-bold text-shadow-md`}>{t('services.surface_finishing_page.card1_title')}</p>
        <p className={`${lang === 'ar' ? 'text-2xl' : 'text-xl'} font-semibold text-shadow-md`}>{t('services.surface_finishing_page.card1_subtitle')}</p>
      </div>
    </div>
    ...
    >
      ...
      <div className="absolute p-4 inset-0 flex items-center justify-between flex-col text-white">
        <p className={`${lang === 'ar' ? 'text-3xl' : 'text-2xl'} font-bold text-shadow-md`}>{t('services.surface_finishing_page.card2_title')}</p>
        <p className={`${lang === 'ar' ? 'text-2xl' : 'text-xl'} text-shadow-md font-semibold`}>{t('services.surface_finishing_page.card2_subtitle')}</p>
      </div>
    </div>
    ...
    >
      ...
      />
      <div className="absolute p-4 inset-0 flex items-center justify-between flex-col text-white">
        <p className={`${lang === 'ar' ? 'text-3xl' : 'text-2xl'} font-bold text-shadow-md`}>{t('services.surface_finishing_page.card3_title')}</p>
        <p className={`${lang === 'ar' ? 'text-2xl' : 'text-xl'} text-shadow-md font-semibold`}>{t('services.surface_finishing_page.card3_subtitle')}</p>
      </div>
    </div>
  </div>
</div>
